       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>Busquedad de Libros <small class="tittles-pages-logo">MyLibrary</small></h1>
            </div>
            <div class="container-fluid">
              <div class="row">
                <div class="col-xs-8 col-md-4 col-md-offset-6">
                  <form action="./search.php" method="GET">
                    <div class="form-group">
                      <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-search" aria-hidden="true"></i></span>
                        <input type="text" id="addon1" class="form-control" name="term" required="" title="Escriba titulo del libro">
