                        ...
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            ...
                            <p class="text-center">
                             ...
                             <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalTran">Pago cheque</button>
                            </p>
            ...
            <p>
              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="Cedclien" placeholder="CODIGO del cliente" maxlength="15" required="">
                </div>
                <div class="form-group">
